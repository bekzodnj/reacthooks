      ...
      <section className='p-2'>
        ...
        <div className='mb-4'>
          ...
          <ul className='list-inside list-decimal'>
            <li>
              Updating a ref value does not trigger re-rendering while setting a
              new state value makes the component re-render; The reference
              update is synchronous.
            </li>
            <li>
              The updated ref value is available right away, while the state
              update is asynchronous (the state is updated after re-rendering).
            </li>
          </ul>
        </div>
      </section>
